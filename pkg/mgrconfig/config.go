...
type DirectedGreyboxFuzzing struct {
	// Path to the graph file which was generated by networkx library.
	GraphFileName string `json:"graph_file"`

	// Target function name for directed greybox fuzzing.
	FunctionName string `json:"target_function"`
}
